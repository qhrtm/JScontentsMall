...
if (G5_IS_MOBILE) {
    include_once(G5_MCONTENTS_PATH.'/itemqa.php');
    return;
}
...
$sql_common = " from `{$g5['g5_contents_item_qa_table']}` where it_id = '{$it_id}' ";
...
$itemqa_skin = G5_CONTENTS_SKIN_PATH.'/itemqa.skin.php';
