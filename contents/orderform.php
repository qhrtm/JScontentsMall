...
if (G5_IS_MOBILE) {
    include_once(G5_MCONTENTS_PATH.'/orderform.php');
    return;
}
...
$order_action_url = G5_HTTPS_CONTENTS_URL.'/orderformupdate.php';
...
<div id="cod_frm">
    ...
    <section id="sod_frm_pay">
        ...
        ?>
            ...
            <input type="text" name="od_temp_point" value="0" id="od_temp_point" class="frm_input" size="10">점 (<?php echo $point_unit; ?>점 단위로 입력하세요.)</div>
        <?php
            $multi_settle++;
            }
        }
...
function forderform_check(f)
{
    ...
    check_field(f.od_name, "구매하시는 분 이름을 입력하십시오.");
    ...
    check_field(f.od_tel, "구매하시는 분 전화번호를 입력하십시오.");
    ...
    var tot_price = od_price - temp_point - temp_cash;
    ...
    f.LGD_RECEIVER.value = f.od_name.value;
    f.LGD_RECEIVERPHONE.value = f.od_hp.value;
    ...
    f.recvname.value    = f.od_name.value;
    f.recvtel.value     = f.od_tel.value;
