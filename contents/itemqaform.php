...
if (G5_IS_MOBILE) {
    include_once(G5_MCONTENTS_PATH.'/itemqaform.php');
    return;
}
...
if ($w == "u")
{
    $qa = sql_fetch(" select * from {$g5['g5_contents_item_qa_table']} where iq_id = '$iq_id' ");
    if (!$qa) {
...
$itemqaform_skin = G5_CONTENTS_SKIN_PATH.'/itemqaform.skin.php';
