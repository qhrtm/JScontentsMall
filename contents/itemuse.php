...
if (G5_IS_MOBILE) {
    include_once(G5_MCONTENTS_PATH.'/itemuse.php');
    return;
}
...
$sql_common = " from `{$g5['g5_contents_item_use_table']}` where it_id = '{$it_id}' and is_confirm = '1' ";
...
$itemuse_skin = G5_CONTENTS_SKIN_PATH.'/itemuse.skin.php';
