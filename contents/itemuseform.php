...
if (G5_IS_MOBILE) {
    include_once(G5_MCONTENTS_PATH.'/itemuseform.php');
    return;
}
...
if ($w == "") {
    ...
    $use = sql_fetch(" select * from {$g5['g5_contents_item_use_table']} where is_id = '$is_id' ");
    if (!$use) {
...
$itemuseform_skin = G5_CONTENTS_SKIN_PATH.'/itemuseform.skin.php';
