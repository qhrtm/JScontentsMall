...
$sql = " select it_id, ca_id, ca_id2, ca_id3 from {$g5['g5_contents_item_table']} where it_id = '$it_id' ";
$it = sql_fetch($sql);

// 상품 총 금액
if($sw_direct)
    $cart_id = get_session('ss_cm_cart_direct');
else
...
<div id="cp_frm">
    ...
    <div class="tbl_head02 tbl_wrap">
        ...
        for($i=0; $row=sql_fetch_array($result); $i++) {
            // 사용한 쿠폰인지 체크
            if(cm_is_used_coupon($member['mb_id'], $row['cp_id']))
                continue;
