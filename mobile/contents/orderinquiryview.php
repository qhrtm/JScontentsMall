...
<div id="sod_fin">
        ...
        <ul id="sod_list_inq" class="sod_list">
            ...
            <li class="sod_li">
                ...
                <ul class="cod_opt">
                    ...
                    ?>
                    <li>
                        <span><?php echo $opt['ct_option']; ?></span>
                        <span><?php echo number_format($opt['ct_qty']); ?>개</span>
                        <span class="cod_status"><?php echo $opt_status; ?></span>
                    </li>
                    <?php
                        $tot_point       += $point;
    ...
    ?>
    <p class="od_p">관리자가 가상계좌 테스트를 한 경우에만 보입니다.</p>
    <div class="tbl_frm01 tbl_wrap od_acc">
        ...
        <tr>
            ...
            <td><input type="text" name="noti_url" value="<?php echo G5_CONTENTS_URL; ?>/settle_kcp_common.php" class="frm_input" size="30"></td>
        </tr>
        </tbody>
        </table>
